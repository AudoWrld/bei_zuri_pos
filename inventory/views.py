...
def inventory_home(request):
    ...
    for item in wholesale_sales:
        wholesale_price = item.product.wholesale_price if item.product.wholesale_price else item.product.selling_price
    ...
    recent_stock_movements = StockMovement.objects.select_related('product').order_by('-created_at')[:10]
